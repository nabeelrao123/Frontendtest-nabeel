...
const Profilecard = () => {
  ...
  return (
    ...
    <>
        {/* Left Side (25%) */}
        <div className="border-2 bg-white rounded-lg shadow-[0px_4px_15px_0px_#0000001A]">
          <div className="relative bg-blue-300 h-[130px] w-full">
            <img
              src={rectan}
              alt="Service icon"
          ...
          <div className="mt-10 mb-5 flex flex-col px-5 py-2 space-y-2   ">
            <p class="font-['Neue_Haas_Grotesk_Display_Pro'] text-[#333333] font-bold text-[18px] leading-[100%] tracking-[0%] text-center">
              Albert Flores
            </p>

            <p class="font-['Neue_Haas_Grotesk_Display_Pro'] text-[#333333] font-medium text-[14px] leading-[100%] tracking-[0%] text-center">
              Senior Product Designer  |  UI/UX Designer  |  Graphic Designer  |  Web...
            </p>

            <p class="font-['Neue_Haas_Grotesk_Display_Pro'] text-[#585D6E] font-light text-[12px] leading-[100%] tracking-[0%] text-center">
              Clinton, Maryland
            </p>
