...
const News = () => {
  ...
  const products = [
    {
      name: "Iron Scrap",
      image: "https://images.unsplash.com/photo-1620748698226-b6a8a5e1e9f7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
      price: "$120 - $250/ton",
      status: "In Stock"
    },
    {
      name: "Steel Scrap",
      image: "https://images.unsplash.com/photo-1593941707882-a5bba5338fe2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
      price: "$180 - $320/ton",
      status: "In Stock"
    },
    {
      name: "Copper Scrap",
      image: "https://images.unsplash.com/photo-1621533672183-4b4b32f7164e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
      price: "$4.50 - $6.80/lb",
      status: "High Demand"
    },
    {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    ...
                    <p className="text-xl mb-8 text-gray-300">
                      We provide professional scrap metal recycling services with cutting-edge technology and environmentally responsible practices.
                    </p>
            ...
            <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                <motion.div
                  ...
                  transition={{ duration: 0.8 }}
                >
                  <h2 className="text-3xl font-bold mb-6 text-yellow-500">Company Overview</h2>
          ...
          <section className="section-padding" style={{ padding: '5rem 0' }}>
            <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
              ...
              <p className="text-xl text-gray-400 mb-12 text-center max-w-3xl mx-auto">
                We buy and sell a wide variety of scrap metals. Browse our product categories below.
              </p>
              ...
              {/* Other Metals */}
              <div className="mt-16">
                <h2 className="text-3xl font-bold mb-8 text-center text-yellow-500">Other Metals We Recycle</h2>
                
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {otherMetals.map((metal, index) => (
                    <div key={index} className="bg-gray-800 rounded-lg p-6 text-center card-hover">
                      <div className="text-teal-600 text-3xl mb-4">
                        <FontAwesomeIcon icon={metal.icon} />
                      </div>
                      <h4 className="font-bold text-xl">{metal.name}</h4>
                      <p className="text-gray-400 mt-2">{metal.price}</p>
                    </div>
                  ))}
                </div>
              </div>
